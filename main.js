...
function displayCoins(cryptRequest) {
    for (let i = 0; i < 300; i++) {
        ...
        <div class="card-body">   
            ...
            <div class="row">
                <button onclick="getMoreInfo(id)" id="${cryptRequest[i].id}" class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample${i}" aria-expanded="false" aria-controls="collapseExample${i}">
                    More Info
                </button>
